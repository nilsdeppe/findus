...
namespace {
struct MyBytesType : rts::serialize::as_bytes<void> {
  int a = 0;
  double b = 0.0;
  MyBytesType() = default;
...
struct ComplexType {
  int id = 0;
  double value = 0.0;
  rts::serialize::Serializer& serialize(rts::serialize::Serializer& s) {
    return s | id | value;
  }
  ComplexType(const int id_in, const double value_in)
      : id(id_in), value(value_in) {}
  ComplexType(rts::serialize::Serializer& s) { serialize(s); }
...
void test_serialize_container(Container& original) {
  rts::serialize::Serializer sizer{rts::serialize::Serializer::Sizing};
  sizer | original;
  CHECK(sizer.number_of_bytes() > 0);

  std::unique_ptr<std::byte[]> buffer{new std::byte[sizer.number_of_bytes()]};
  rts::serialize::Serializer packer{rts::serialize::Serializer::Packing,
                                    buffer.get(), sizer.number_of_bytes()};
  packer | original;

  Container unpacked;
  rts::serialize::Serializer unpacker{rts::serialize::Serializer::Unpacking,
                                      buffer.get(), sizer.number_of_bytes()};
  unpacker | unpacked;
...
TEST_CASE("Serialize.Set") {
  ...
  static_assert(rts::serialize::is_serializable_v<std::set<int>>);
  ...
  static_assert(rts::serialize::is_serializable_v<std::set<MyBytesType>>);
  test_serialize_container(s_my_bytes_type);

  // Test with non-trivial type
  std::set<ComplexType> s_complex;
  static_assert(rts::serialize::is_serializable_v<std::set<ComplexType>>);
  s_complex.emplace(1, 3.14);
  s_complex.emplace(2, 2.71);
  test_serialize_container(s_complex);

  static_assert(not rts::serialize::is_serializable_v<std::set<NoSerialize>>);
}

TEST_CASE("Serialize.Multiset") {
  // Test with fundamental type
  std::multiset<int> ms_int{1, 2, 3, 4, 5, 3, 2};
  static_assert(rts::serialize::is_serializable_v<std::multiset<int>>);
  ...
  std::multiset<MyBytesType> ms_my_bytes{
      MyBytesType{1, 1.1}, MyBytesType{2, 2.2}, MyBytesType{3, 3.3},
      MyBytesType{2, 2.2}};
  static_assert(rts::serialize::is_serializable_v<std::multiset<MyBytesType>>);
  test_serialize_container(ms_my_bytes);

  // Test with non-trivial type
  std::multiset<ComplexType> ms_complex;
  static_assert(rts::serialize::is_serializable_v<std::multiset<ComplexType>>);
  ...
  static_assert(
      not rts::serialize::is_serializable_v<std::multiset<NoSerialize>>);
}

TEST_CASE("Serialize.UnorderedSet") {
  // Test with fundamental type
  std::unordered_set<int> s_int{1, 2, 3, 4, 5};
  static_assert(rts::serialize::is_serializable_v<std::unordered_set<int>>);
  test_serialize_container(s_int);
  ...
  std::unordered_set<MyBytesType> s_my_bytes_type{
      MyBytesType{1, 1.1}, MyBytesType{2, 2.2}, MyBytesType{3, 3.3}};
  static_assert(
      rts::serialize::is_serializable_v<std::unordered_set<MyBytesType>>);
  test_serialize_container(s_my_bytes_type);

  // Test with non-trivial type
  std::unordered_set<ComplexType> s_complex;
  static_assert(
      rts::serialize::is_serializable_v<std::unordered_set<ComplexType>>);
  s_complex.emplace(1, 3.14);
  s_complex.emplace(2, 2.71);
  test_serialize_container(s_complex);

  static_assert(
      not rts::serialize::is_serializable_v<std::unordered_set<NoSerialize>>);
}
...
TEST_CASE("Serialize.UnorderedMultiset") {
  ...
  static_assert(
      rts::serialize::is_serializable_v<std::unordered_multiset<int>>);
  test_serialize_container(ms_int);
  ...
  std::unordered_multiset<MyBytesType> ms_my_bytes{
      ...
      MyBytesType{2, 2.2}};
  static_assert(
      rts::serialize::is_serializable_v<std::unordered_multiset<MyBytesType>>);
  test_serialize_container(ms_my_bytes);

  // Test with non-trivial type
  std::unordered_multiset<ComplexType> ms_complex;
  static_assert(
      rts::serialize::is_serializable_v<std::unordered_multiset<ComplexType>>);
  ms_complex.emplace(1, 3.14);
  ms_complex.emplace(2, 2.71);
  ms_complex.emplace(1, 3.14);
  test_serialize_container(ms_complex);

  static_assert(not rts::serialize::is_serializable_v<
...
TEST_CASE("Serialize.Map") {
  ...
  static_assert(rts::serialize::is_serializable_v<std::map<int, double>>);
  static_assert(
      not rts::serialize::is_serializable_v<std::map<NoSerialize, double>>);
  static_assert(
      not rts::serialize::is_serializable_v<std::map<int, NoSerialize>>);
  ...
  std::map<int, MyBytesType> m_bytes{{1, MyBytesType{1, 1.1}},
                                     {2, MyBytesType{2, 2.2}},
                                     {3, MyBytesType{3, 3.3}}};
  static_assert(rts::serialize::is_serializable_v<std::map<int, MyBytesType>>);
  static_assert(not rts::serialize::is_serializable_v<
  ...
  static_assert(rts::serialize::is_serializable_v<std::map<int, ComplexType>>);
  static_assert(not rts::serialize::is_serializable_v<
...
TEST_CASE("Serialize.Multimap") {
  ...
  static_assert(rts::serialize::is_serializable_v<std::multimap<int, double>>);
  static_assert(not rts::serialize::is_serializable_v<
                std::multimap<NoSerialize, double>>);
  static_assert(
      not rts::serialize::is_serializable_v<std::multimap<int, NoSerialize>>);
  ...
  std::multimap<int, MyBytesType> mm_bytes{{1, MyBytesType{1, 1.1}},
                                           ...
                                           {2, MyBytesType{4, 4.4}}};
  static_assert(
      rts::serialize::is_serializable_v<std::multimap<int, MyBytesType>>);
  static_assert(not rts::serialize::is_serializable_v<
  ...
  static_assert(
      rts::serialize::is_serializable_v<std::multimap<int, ComplexType>>);
  static_assert(not rts::serialize::is_serializable_v<
...
TEST_CASE("Serialize.UnorderedMap") {
  ...
  static_assert(
      rts::serialize::is_serializable_v<std::unordered_map<int, double>>);
  static_assert(not rts::serialize::is_serializable_v<
  ...
  std::unordered_map<int, MyBytesType> m_bytes{{1, MyBytesType{1, 1.1}},
                                               ...
                                               {3, MyBytesType{3, 3.3}}};
  static_assert(
      rts::serialize::is_serializable_v<std::unordered_map<int, MyBytesType>>);
  static_assert(not rts::serialize::is_serializable_v<
  ...
  static_assert(
      rts::serialize::is_serializable_v<std::unordered_map<int, ComplexType>>);
  static_assert(not rts::serialize::is_serializable_v<
...
TEST_CASE("Serialize.UnorderedMultimap") {
  ...
  static_assert(
      rts::serialize::is_serializable_v<std::unordered_multimap<int, double>>);
  static_assert(not rts::serialize::is_serializable_v<
  ...
  std::unordered_multimap<int, MyBytesType> mm_bytes{{1, MyBytesType{1, 1.1}},
                                                     ...
                                                     {3, MyBytesType{3, 3.3}},
                                                     {2, MyBytesType{4, 4.4}}};
  static_assert(rts::serialize::is_serializable_v<
