...
#include "findus/Serialize/Exception.hpp"
...
namespace detail {
// We put this in a helper so we can disable the sanitizer for just this one
// line. There currently is no way to disable the sanitizer by comment,
// unfortunately.
#if defined(__clang__)
__attribute__((no_sanitize("undefined", "integer")))
#endif
constexpr inline void
fnv1a_hash_multiply(size_t& hash) {
